...
import { CreateTransactionSchemaType, CreateTransactionSchmea } from "@/schema/transaction";
...
function CreateTransactionDialog({ trigger, type }: Props) {
  ...
  const handleCategoryOnChange = useCallback((value: string) => {
              ...
              <FormField 
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <CategoryPicker type={type} onChange={handleCategoryOnChange} />
                    </FormControl>
